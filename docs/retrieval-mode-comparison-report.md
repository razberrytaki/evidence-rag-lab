...
- 키워드 검색은 recall@3 15/20, MRR 0.750로 정확 토큰 신호를 확인한다.
...
| pgvector-hnsw | lexical | semantic | 통과 | pgvector-indexing-note | 1.000 | 첫 관련 문서 순위 1 |
...
| chunking-boundary | lexical | retrieval-design | 통과 | chunking-strategy-note | 1.000 | 첫 관련 문서 순위 1 |
...
| rag-query-mode-config-key | lexical | exact-token | 통과 | config-key-routing-note | 1.000 | 첫 관련 문서 순위 1 |
| unknown-chunk-error-code | lexical | exact-token | 통과 | error-code-runbook-note | 1.000 | 첫 관련 문서 순위 1 |
| selected-chunk-ids-field | lexical | exact-token | 통과 | api-field-contract-note | 1.000 | 첫 관련 문서 순위 1 |
| rrf-acronym-collision | lexical | exact-token | 통과 | acronym-collision-note | 1.000 | 첫 관련 문서 순위 1 |
| runbook-id-rollback | lexical | exact-token | 통과 | runbook-id-rollback-note | 1.000 | 첫 관련 문서 순위 1 |
